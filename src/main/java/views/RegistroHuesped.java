...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(Long reservaNumber) {	
		...
		if(reservaNumber != null) {
			txtNreserva.setText(reservaNumber.toString());
		}
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (txtNombre.getText() != null && txtApellido.getText() != null && txtTelefono.getText() != null && 
						txtNreserva.getText() != null && txtFechaN.getDate() != null && 
						txtNacionalidad.getSelectedItem() != null &&  txtNreserva.getText() != null) {	
					try {
						
						Long reservaNumber = Long.parseLong(txtNreserva.getText());
						huespedDao.saveHuesped(txtNombre.getText(), txtApellido.getText(), txtFechaN.getDate(), 
								txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), reservaNumber);

						JOptionPane.showMessageDialog(null, "Se ha registrado el huesped con exito. \nNumero de reservacion: " + txtNreserva.getText());
						...
						//exception.printStackTrace();				//Only enable in dev mode
						JOptionPane.showMessageDialog(null, "Ha ocurrido un error al registrar al huesped.");
					}
